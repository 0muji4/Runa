...
fun SettingsScreen(
    ...
    val notification by notificationViewModel.state.collectAsStateWithLifecycle()
...
private fun SettingRow(
    ...
    Row(
        ...
        Icon(icon, contentDescription = null, tint = labelColor, modifier = Modifier.size(22.dp))
