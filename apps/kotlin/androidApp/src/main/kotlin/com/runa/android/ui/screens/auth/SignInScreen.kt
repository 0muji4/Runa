...
/**
 * Sign-in: Apple / Google / メール, with email as a second step. 「いまはスキップ」 is
 * intentionally absent: no guest session exists, so signing in is the only way past the gate.
 */
@Composable
fun SignInScreen(
    isBusy: Boolean,
